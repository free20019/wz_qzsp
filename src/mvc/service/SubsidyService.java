...
public class SubsidyService {
    ...
    public String findBusinessOwnerSubsidy(HttpServletRequest request) {
        ...
        String cphm = request.getParameter("cphm") == null ? "" : request.getParameter("cphm").trim();
        ...
        tj2 += " and (a.sqrlx = '0' or a.sqrlx = '1')";
        tj2 += " and a.owner_id = '"+owner_id+"'";

        String sql = "select (select count(*) from (select max(SQSJ) SQSJ, cphm from tb_zxbz a where 1=1 ";
        sql += tj2;
        sql +=  " group by cphm) b,tb_zxbz a where a.cphm=b.cphm and a.SQSJ=b.SQSJ";
        sql += tj;
        sql += tj2;
        sql +=  ") as count, tt.* from (select t.*, rownum rn from (select a.* from (select max(SQSJ) SQSJ, cphm from tb_zxbz a where 1=1 ";
        sql += tj2;
        sql +=  " group by cphm) b,tb_zxbz a where a.cphm=b.cphm and a.SQSJ=b.SQSJ";
        sql += tj;
        sql += tj2;
    ...
    public synchronized String addBusinessOwnerSubsidy(HttpServletRequest request) {
        String sqrlx = request.getParameter("sqrlx") == null ? "" : request.getParameter("sqrlx");
        String owner_id = String.valueOf(request.getSession().getAttribute("dlid"));
        if(null == owner_id||owner_id.isEmpty()||"null".equals(owner_id)){
            return  "{\"info\":\"您长时间未操作或账号在别的地方登陆，请重新登录\"}";
        }
        String insert = "";
        if("0".equals(sqrlx)){
            String cphm = request.getParameter("cphm") == null ? "" : request.getParameter("cphm").trim();
            ...
            String pyht12 = request.getParameter("pyht12") == null ? "" : request.getParameter("pyht12");
            String pyht13 = request.getParameter("pyht13") == null ? "" : request.getParameter("pyht13");
            String pyht14 = request.getParameter("pyht14") == null ? "" : request.getParameter("pyht14");
            String pyht22 = request.getParameter("pyht22") == null ? "" : request.getParameter("pyht22");
            String pyht23 = request.getParameter("pyht23") == null ? "" : request.getParameter("pyht23");
            String pyht24 = request.getParameter("pyht24") == null ? "" : request.getParameter("pyht24");
            String pyht32 = request.getParameter("pyht32") == null ? "" : request.getParameter("pyht32");
            String pyht33 = request.getParameter("pyht33") == null ? "" : request.getParameter("pyht33");
            String pyht34 = request.getParameter("pyht34") == null ? "" : request.getParameter("pyht34");
            List<Map<String, Object>> list = jdbcTemplate.queryForList("select * from tb_zxbz where IS_YX='0' and sqrlx!='2' and REPLACE(cphm,'.','') = '"+cphm.replace(".","")+"'");
            if(list.size()>0){
...
//            }
            ...
            if(!("".equals(pyht23)&&"".equals(pyht24))){
                if("".equals(cyzgz2)){
                    return "{\"info\":\"请上传从业资格证\"}";
                }
                if("".equals(pyht2)){
                ...
                if(!("".equals(cyzgz2)&&"".equals(pyht2)&&"".equals(pyht22))){
                    if("".equals(cyzgz2)){
                        return "{\"info\":\"请上传从业资格证\"}";
                    }
                    if("".equals(pyht2)){
            ...
            if(!("".equals(pyht33)&&"".equals(pyht34))){
                if("".equals(cyzgz3)){
                    return "{\"info\":\"请上传从业资格证\"}";
                }
                if("".equals(pyht3)){
                ...
                if(!("".equals(cyzgz3)&&"".equals(pyht3)&&"".equals(pyht32))){
                    if("".equals(cyzgz3)){
                        return "{\"info\":\"请上传从业资格证\"}";
                    }
                    if("".equals(pyht3)){
           ...
           insert = "insert into tb_zxbz (cphm, sqrlx, owner_id, sqrxm, sfzh, sjhm, jyqrsfzzm, jyqrsfzfm, qksm, yszzb, yszfb, cyzgz1, pyht1, cyzgz2, pyht2, cyzgz3, pyht3, sqsj, pyht12, pyht13, pyht14, pyht22, pyht23, pyht24, pyht32, pyht33, pyht34) " +
                    " values ('"+cphm+"', '"+sqrlx+"', '"+owner_id+"', '"+sqrxm+"', '"+sfzh+"', '"+sjhm+"', '"+jyqrsfzzm+"', '"+jyqrsfzfm+"', '"+qksm+"', '"+yszzb+"', '"+yszfb+"', '"+cyzgz1+"', '"+pyht1+"', '"+cyzgz2+"', '"+pyht2+"', '"+cyzgz3+"', '"+pyht3+"', sysdate, '"+pyht12+"', '"+pyht13+"', '"+pyht14+"', '"+pyht22+"', '"+pyht23+"', '"+pyht24+"', '"+pyht32+"', '"+pyht33+"', '"+pyht34+"')";
...
//            }
            ...
            insert = "insert into tb_zxbz (cphm, sqrlx, owner_id, sqrxm, qyyyzz, sjhm, jyqrsfzzm, jyqrsfzfm, qksm, yszzb, yszfb, cyzgz1, pyht1, cyzgz2, pyht2, cyzgz3, pyht3, sqsj, pyht12, pyht13, pyht14, pyht22, pyht23, pyht24, pyht32, pyht33, pyht34) " +
                " values ('"+cphm+"', '"+sqrlx+"', '"+owner_id+"', '"+sqrxm+"', '"+qyyyzz+"', '"+sjhm+"', '"+jyqrsfzzm+"', '"+jyqrsfzfm+"', '"+qksm+"', '"+yszzb+"', '"+yszfb+"', '"+cyzgz1+"', '"+pyht1+"', '"+cyzgz2+"', '"+pyht2+"', '"+cyzgz3+"', '"+pyht3+"', sysdate, '"+pyht12+"', '"+pyht13+"', '"+pyht14+"', '"+pyht22+"', '"+pyht23+"', '"+pyht24+"', '"+pyht32+"', '"+pyht33+"', '"+pyht34+"')";
        }else{
    ...
    public synchronized String addCompanySubsidy(HttpServletRequest request) {
        String sqrlx = request.getParameter("sqrlx") == null ? "" : request.getParameter("sqrlx");
        String owner_id = String.valueOf(request.getSession().getAttribute("dlid"));
        if(null == owner_id||owner_id.isEmpty()||"null".equals(owner_id)){
            return  "{\"info\":\"您长时间未操作或账号在别的地方登陆，请重新登录\"}";
